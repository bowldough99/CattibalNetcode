...
public class CattibalLobbyManager : MonoBehaviour
{

    public static CattibalLobbyManager Instance { get; private set; }


    public const string KEY_PLAYER_NAME = "PlayerName";
    public const string KEY_PLAYER_SKIN = "Skin";
    ...
    private void Awake()
    {
        Instance = this; //CHRISTINE what does this do?
    }
    ...
    private Player GetPlayer()
    {
        return new Player(AuthenticationService.Instance.PlayerId, null, new Dictionary<string, PlayerDataObject> {
            ...
            { KEY_PLAYER_SKIN, new PlayerDataObject(PlayerDataObject.VisibilityOptions.Public, PlayerSkin.Tuxedo.ToString()) }
        });
    }
    ...
    public async void UpdatePlayerCharacter(PlayerSkin playerSkin)
    {
        if (joinedLobby != null)
        {
            try
            {
                ...
                options.Data = new Dictionary<string, PlayerDataObject>() {
                    {
                        KEY_PLAYER_SKIN, new PlayerDataObject(
                            visibility: PlayerDataObject.VisibilityOptions.Public,
                            value: playerSkin.ToString())
                    }
                };
